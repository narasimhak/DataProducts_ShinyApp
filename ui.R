# Assignment: Course Project: Shiny Application

# ui.R file for the shiny application

# This application is developed to choose the best car for their trip, using mtcars dataset from [R] 

library(markdown)

shinyUI(navbarPage("Choosing ideal car for trip",
                   tabPanel("Table",
